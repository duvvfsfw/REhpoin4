...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "REhpoin"; Text ="正在为您启动中"; Duration = 5; })wait("2")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "RE脚本"; Text ="制作人DoxZcn7与回响"; Duration = 2; })wait("2")

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "REhpoin"; Text ="启动成功"; Duration = 4; })
...
local function HeartbeatUpdate()
	...
	FpsLabel.Text = ("中国北京时间:"..os.date("%H").."时"..os.date("%M").."分"..os.date("%S"))
end
Start = tick()
...
local win = ui:new("RE脚本")
--
local UITab1 = win:Tab("信息",'QQ364494103')

local about = UITab1:section("作者信息",false)

about:Label("REhpoin")
about:Label("作者：DoxZcn7与回响")
about:Label("脚本正在测试中")
about:Label("脚本禁止倒卖")
